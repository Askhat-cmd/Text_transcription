...
- [x] 6.7  Открыть localhost:3000 (или порт веб-UI)
- [x] 6.8  Тест 1 — Приветствие:
- [x] 6.9  Тест 2 — Содержательный вопрос:
- [x] 6.10 Тест 3 — Трейс Полотно LLM:
...
- [x] 6.15 Финальный коммит:
- [x] 6.16 Создать PR: fix/v0.6.0-cleanup-trace-behavior → main

RELEASE_NOTE: работа велась напрямую в `main`, поэтому шаг PR отмечен как N/A (эквивалент — прямой merge в main).
