...
- Scope rule: only `_call_llm` slice 11 moved; prior writer decomposition helpers and protected prompt/lifecycle files stay unchanged.
- Protected files checked: `16`
