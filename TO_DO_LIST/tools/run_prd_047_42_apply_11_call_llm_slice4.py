...
PRD_ID = "PRD-047.42-APPLY-11"
OUT_DIR = REPO_ROOT / "TO_DO_LIST" / "logs" / PRD_ID
NORMALIZED_TIMESTAMP = "normalized_for_prd_047_42_apply_11"
PROTECTED_FILES = [
...
def build_no_mutation_proof() -> str:
    ...
    lines = [
        ...
        "",
        f"- PRD: `{PRD_ID}`",
        "- Scope rule: only `_call_llm` slice 4 prompt-argument extraction moved; previously accepted helper/mixin/admin/contract files stay unchanged.",
