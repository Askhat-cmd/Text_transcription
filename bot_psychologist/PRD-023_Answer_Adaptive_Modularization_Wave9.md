...
## Scope (Wave 9)
Extract success-metadata builders to `adaptive_runtime/response_utils.py` and replace inline dicts in `answer_adaptive.py`.
...
## Technical Design
Add helpers in `response_utils.py`:
