...
## Scope (Wave 90)
Narrow unhandled-exception contract by localizing error/debug-finalization internals inside `response_utils.py`.
...
## Technical Design
Update `bot_agent/adaptive_runtime/response_utils.py`:
