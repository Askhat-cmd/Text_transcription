...
## Context
After Wave 133, `routing_stage_helpers.py` became a façade. Some runtime modules still imported through old façade paths or imported `_estimate_cost` via `runtime_misc_helpers`.
...
3. Preserve compatibility façade for external callers/tests.
