...
## Context
After Wave 136 extraction, some callsites still imported success helpers indirectly from `response_utils.py`.
...
- Keep backward compatibility in `response_utils.py`.
