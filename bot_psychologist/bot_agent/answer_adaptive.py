...
def answer_question_adaptive(
    ...
    try:
        ...
        success_stage = _finalize_full_path_success_stage(
            ...
            build_success_response_fn=lambda path_recommendation, feedback_prompt, concepts, tokens_prompt, tokens_completion, tokens_total, model_used, session_metrics: _build_full_path_success_response(
                answer=answer,
                state_analysis=state_analysis,
