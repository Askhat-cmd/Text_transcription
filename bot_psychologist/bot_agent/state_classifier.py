...
{{
  ...
  "indicators": ["indicator1", "indicator2"]
    ...
    def _get_recommendations_for_state(self, state: UserState) -> List[str]:
        ...
        recommendations = {
            UserState.UNAWARE: [
                "Объясни через простые примеры",
                "Покажи практическую пользу",
                "Предложи первый безопасный шаг",
                "Не перегружай деталями"
            ],
            UserState.CURIOUS: [
                "Поддержи интерес и исследование",
                "Добавь глубину и несколько перспектив",
                "Предложи следующий шаг для самоисследования",
                "Рекомендуй подходящую практику"
            ],
            UserState.OVERWHELMED: [
                "Упростить объяснение и снизить нагрузку",
                "Разбить на короткие шаги",
                "Сфокусироваться на одном ближайшем действии",
                "Предложить мягкий способ саморегуляции"
            ],
            UserState.RESISTANT: [
                "Сначала отзеркаль без давления",
                "Опирайся на факты и наблюдения",
                "Предложи выбор из альтернатив",
                "Говори языком пользователя"
            ],
            UserState.CONFUSED: [
                "Проясни ключевые понятия простыми словами",
                "Дай конкретный пример из жизни",
                "Переформулируй короче",
                "Выяви источник путаницы"
            ],
            UserState.COMMITTED: [
                "Дай чёткий план действий",
                "Предложи практику на сегодня",
                "Поддержи мотивацию",
                "Зафиксируй критерии прогресса"
            ],
            UserState.PRACTICING: [
                "Помоги разобрать затруднение",
                "Отметь конкретный прогресс",
                "Предложи следующий уровень практики",
                "Поддержи устойчивую мотивацию"
            ],
            UserState.STAGNANT: [
                "Нормализуй плато и усталость",
                "Дай новый угол наблюдения",
                "Вариативно измени практику",
                "Напомни про смысл и цель"
            ],
            UserState.BREAKTHROUGH: [
                "Подтверди инсайт",
                "Помоги встроить его в поведение",
                "Предложи применение в реальной ситуации",
                "Наметь следующий шаг развития"
            ],
            UserState.INTEGRATED: [
                "Поддержи применение в ежедневности",
                "Предложи следующую глубину",
                "Сохрани партнёрский стиль исследования",
                "Укрепи устойчивое развитие"
            ]
        }
