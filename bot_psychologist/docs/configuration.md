...
│ LEGACY_legacy_sag_final:    /path/to/LEGACY_legacy_sag_final
...
1. **API Keys**: спользуйте сильные ключи, храните в секретах
...
```env
# OpenAI API
OPENAI_API_KEY=sk-proj-...  # з секретов
