...
1. **спользуйте процесс-менеджер**: systemd, supervisor, или PM2
2. **Настройте reverse proxy**: Nginx или Apache
3. **спользуйте HTTPS**: SSL/TLS сертификаты
4. **Настройте мониторинг**: логирование, метрики, алерты
5. **спользуйте секреты**: храните API ключи в секретах
...
спользуйте endpoint `/api/v1/health` для проверки состояния:
...
1. **стория диалогов**: `.cache_bot_agent/conversations/`
...
3. спользуйте более быструю модель LLM
