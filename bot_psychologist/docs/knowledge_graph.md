...
**Knowledge Graph** — граф знаний, построенный из Legacy SAG v2.0 () данных, содержащий:
...
class GraphEdge:
    ...
    from_name: str         # мя исходного узла
    to_name: str           # мя целевого узла
...
**спользование**: Основные концепты, которые объясняются в лекциях.
...
**спользование**: Рекомендация практик для концептов через связи IS_PRACTICE_FOR.
...
**спользование**: Детальные инструкции по выполнению практик.
...
**спользование**: Практические упражнения для развития навыков.
...
**спользование**: Распознавание и работа с паттернами.
...
**спользование**: Построение путей трансформации.
...
**спользование**: Поиск практик для концептов.
...
**спользование**: Поиск техник для практик.
...
**спользование**: Определение предпосылок для практик.
...
**спользование**: Построение цепочек развития.
...
**спользование**: Построение иерархий.
...
**спользование**: Поиск связанных концептов.
...
**спользование**: Определение последовательности обучения.
...
# 2. звлечение graph_entities → узлы графа
# 3. звлечение graph_relations → связи графа
...
Пользовательский запрос
    ↓
[SemanticAnalyzer] → звлечение концептов
    ↓
...
- **ндексы**: быстрый поиск по имени узла, по типу связи
