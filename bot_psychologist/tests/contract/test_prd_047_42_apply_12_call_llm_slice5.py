...
from TO_DO_LIST.tools import run_prd_047_42_apply_12_call_llm_slice5 as runner
...
def test_runner_normalizes_snapshot_timestamp() -> None:
    ...
    assert all(isinstance(case["last_debug"].get("user_prompt"), str) for case in payload["cases"])
