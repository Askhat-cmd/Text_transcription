...
def test_final_runtime_governance_acceptance_rollback_hard_stop() -> None:
    ...
    assert payload["rollback_failure_count_total"] == 0
    assert payload["hard_stop_triggered_total"] == 0
