...
def test_final_runtime_governance_acceptance_safety_kb_boundary() -> None:
    ...
    assert payload["raw_kb_text_exposure_count_total"] == 0
    assert payload["kb_authority_citation_count_total"] == 0
