...
def test_limited_activation_readiness_artifact_hygiene() -> None:
    report = encoding_validator.run(
        argparse.Namespace(
            prd="PRD-046.1.32",
            logs_dir="TO_DO_LIST/logs/PRD-046.1.32",
            reports_dir="TO_DO_LIST/reports",
            out_dir="TO_DO_LIST/logs/PRD-046.1.32",
            report_prd="PRD-046.1.32",
            repo_root=".",
            fixed_file=[],
        )
    )
