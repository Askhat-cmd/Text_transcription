...
def test_runtime_pilot_payload_keeps_no_user_path_effect() -> None:
    ...
    payload = build_planner_bridge_writer_contract_pilot_runtime_shadow_v1(
    ...
    assert overlay["guardrails"]["writer_contract_changed"] is False
    assert overlay["guardrails"]["writer_prompt_changed"] is False
    assert overlay["guardrails"]["final_answer_changed"] is False
