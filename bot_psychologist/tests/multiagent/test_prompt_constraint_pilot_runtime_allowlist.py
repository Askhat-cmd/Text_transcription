...
def test_non_allowlisted_user_cannot_apply() -> None:
    decision = build_prompt_constraint_pilot_runtime_decision_v1(
        ...
        feature_flags_snapshot={
            ...
            "PROMPT_CONSTRAINT_PILOT_ALLOWED_USER_IDS": "pilot_allow_1",
    ...
    assert "user_not_allowlisted" in decision["blocked_reasons"]
