...
def test_force_disabled_wins_over_enabled_and_mode() -> None:
    decision = build_prompt_constraint_pilot_runtime_decision_v1(
        ...
        feature_flags_snapshot={
            ...
            "PROMPT_CONSTRAINT_PILOT_ALLOWED_USER_IDS": "pilot_1",
    ...
    assert "force_disabled_active" in decision["blocked_reasons"]
