...
def test_response_quality_candidate_detection_thresholds(tmp_path: Path) -> None:
    ...
    assert scorecard["acceptable_candidate_pass_rate"] >= 0.90
    assert scorecard["weak_candidate_detection_rate"] >= 0.85
