...
def test_runtime_pilot_trace_sanitization_gate_passes(tmp_path: Path) -> None:
    ...
    payload = json.loads((out_dir / "trace_sanitization_gate.json").read_text(encoding="utf-8"))
