...
"""
Retired by PRD-047.39 and renamed so pytest does not collect it.

This regression imported bot_agent.answer_adaptive._build_llm_prompts, which no
longer exists in the active runtime. The SD/level prompt removal contract is
covered by bot_psychologist/tests/contract/test_no_legacy.py.
"""
