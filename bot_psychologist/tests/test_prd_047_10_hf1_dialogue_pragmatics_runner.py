...
from scripts.run_prd_047_10_hf1_dialogue_pragmatics_eval import (
    DEFAULT_DATASET,
    REQUIRED_CASE_IDS,
    _run_direct,
    _validate_dataset,
...
def test_dataset_validation_passes_for_prd_047_10_hf1_cases() -> None:
...
def test_direct_mode_executes_required_hf1_cases() -> None:
    payload = json.loads(Path(DEFAULT_DATASET).read_text(encoding="utf-8-sig"))
