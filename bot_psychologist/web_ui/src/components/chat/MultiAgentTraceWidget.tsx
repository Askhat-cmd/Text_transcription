              ...
              <div className="space-y-2">
                ...
                {runtimeConfigTrace && (
                  <AccordionSection title="Effective runtime config" nested>
                    ...
                    <div><span className="text-slate-500">semantic_cards_pilot_enabled:</span> {String(Boolean(runtimeConfigTrace.semantic_cards_pilot_enabled))}</div>
                    <div><span className="text-slate-500">semantic_cards_pilot_enabled_source:</span> {String(runtimeConfigTrace.semantic_cards_pilot_enabled_source || '—')}</div>
                    <div><span className="text-slate-500">semantic_cards_pilot_raw_value:</span> {String(runtimeConfigTrace.semantic_cards_pilot_raw_value || '—')}</div>
                    <div><span className="text-slate-500">semantic_cards_pack_id:</span> {String(runtimeConfigTrace.semantic_cards_pack_id || '—')}</div>
                    <div><span className="text-slate-500">semantic_cards_loaded_count:</span> {String(runtimeConfigTrace.semantic_cards_loaded_count ?? '—')}</div>
