...
const ProfilePage: React.FC = () => {
  ...
  const fetchHistory = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Не удалось загрузить историю пользователя');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-semibold text-lg text-gray-800 dark:text-gray-200">Профиль</h1>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        {history && history.turns.length > 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-4">Последние вопросы</h3>
