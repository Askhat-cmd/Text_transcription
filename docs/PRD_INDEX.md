...
| PRD-046.0.9-RUN1 | Real Provider Enrichment Run after Post-Reprocess Rebaseline v1 | blocked_by_provider | pending | implemented provider preflight/pilot/real RUN1 pipeline; run blocked on `api_key_missing`, no production mutation and no Chroma reindex | TO_DO_LIST/reports/PRD-046.0.9-RUN1_IMPLEMENTATION_REPORT.md |
