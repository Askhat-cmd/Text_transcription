...
| PRD-046.0.7.1 | Controlled Review Decision Apply v1 | done | pending | executed controlled apply from validated overlay (`safe_non_review=160`, `approved=28`, `needs_edit=12`, `rejected/defer skipped`), updated `metadata.llm_enrichment` for `200` blocks with authority invariants preserved, produced backup/proof/smoke artifacts, no Chroma reindex | TO_DO_LIST/reports/PRD-046.0.7.1_IMPLEMENTATION_REPORT.md |
